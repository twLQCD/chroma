...
public:
	...
	// Details of the Multigrid Construction
	int MGLevels;
	multi1d< multi1d<int> > Blocking;
	multi1d< int > NullVecs;
	multi1d< int > NullSolverMaxIters;
...
struct MGProtoALIPrecParams {
public:
	MGProtoALIPrecParams(){ }

	MGProtoALIPrecParams(XMLReader& xml, const std::string& path);
