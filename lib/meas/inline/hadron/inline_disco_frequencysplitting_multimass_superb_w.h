...
#ifndef __inline_disco_frequencysplitting_multimass_superb_w_h__
#define __inline_disco_frequencysplitting_multimass_superb_w_h__
...
{ 
  ...
  namespace InlineDiscoFreqSplitMMSuperb
  {
	...
	multi1d<int> gamma_disp; 	//The gamma and displacement combination to optimize. If not included, one will be automatically chosen 
