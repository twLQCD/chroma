...
#include "meas/inline/hadron/inline_disco_frequencysplitting_multimass_superb_w.h"
...
//	success &= InlineSpectrumEnv::registerAll();
	...
	success &= InlineDiscoFreqSplitMMSuperb::registerAll();
#endif
...
//      success &= InlineMultipoleEnv::registerAll();  // not being used
	...
	success &= InlinePropDistillationStochEnv::registerAll();
